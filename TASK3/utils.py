#####TUWIEN - WS2020 CV: Task3 - Scene recognition with Bag of Visual Words
...
def plot_confusion_matrix(gt_labels, predicted, accuracy, class_names, 
                          group_no = None, name = None):
